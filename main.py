...
def parse():
    ...
    parser.add_argument('-pr', '--prints', type=int, default=100, help='Print every p iterations')
    ...
    parser.add_argument('-p', '--nucleus', type=int, default=1, help='Nucleus (top-p) size.')
    parser.add_argument('-v', '--ved', type=int, default=1, help='Variational encoder-decoder model.')
...
def run(args):
    reverse, fil, n_iteration, print_every, save_every, learning_rate, \
        ...
        args.layer, args.hidden, args.batch_size, args.beam, args.k, args.p, args.v, args.input, args.dropout
